...
runs_uncoated = ['Rn16112020', 'Rn23112020']
runs_coated = ['Rn26112020']
runs_decoated = ['Rn30112020']

file_names = runs_uncoated + runs_coated + runs_decoated

po212_selection = [220,310]
timestamp_cut = [1607173503]
bin_width = int(10 * 60.)
...
for i in range(len(file_names)):
	...
	event_mask2 = np.less(selected_timestamps, timestamp_cut)
	selected_timestamps = selected_timestamps[event_mask2]
...
t_min = start_times[0]
t_max = np.max(time_stamp)#stop_times[-1]

print("sgdaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa " + str(t_max))
...
ax1.set_title("224Ra implantation test (CF63 flange)")
