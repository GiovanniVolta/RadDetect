...
isotope_colors = ["", "black", "royalblue", "tab:red", "tab:cyan", "darkviolet", ""]
fontsize_1 = 20
...
label_text = ["", r"$^{224}$Ra", r"$^{220}$Rn", r"$^{216}$Po", r"$^{212}$Pb", r"$^{212}$Bi & $^{212}$Po", ""]
...
# Plot ratio of 224Ra / 212Po activity over time

plt.figure(figsize=(8,6), constrained_layout=True, dpi=150)

ratio = activities.T[1] / activities.T[5]

plt.plot(times/3600., ratio, linewidth = 3)
plt.show()
