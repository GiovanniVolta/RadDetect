...
#gs = gridspec.GridSpec(ncols=1, nrows=1, figure=fig, height_ratios=[1,])
...
ax1.set_title("224Ra implanted stainless steel sample")

ax1.set_ylabel("Rate (1/s)",fontsize=17)

ax1.set_ylim(5e-5,15)
ax1.set_yscale('log')

#plt.axvspan(0,6.86,facecolor='grey',alpha=0.8)
