...
t0 = 0
runs_uncoated = ['Rn01022021', 'Rn05022021']
t1 = 6.797
runs_coated = ['Rn08022021', 'Rn13022021']
t2 = 14.167
...
if plot_corrected_rate:
    y_axis_act_lim = np.array([0.002, 15])
else:
...
plt.savefig("implanted_ss_3_initial_ra224_1.pdf",dpi="figure")
plt.show()
