...
int analysis(){
	...
	int spec_range[2] = {200, 550};
	int fit_ranges[2] = {250, 500};
	...
	tmp_line_pos.push_back(410);
	iso_energies_indicator.push_back(6778.3);
	...
	filenames.push_back("Ap03062019_with");
