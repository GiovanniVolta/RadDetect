...
t0 = 0
runs_uncoated = ['Mn21072023']
t1 = 4.9
runs_coated = ['Mn26072023']
t2 = 13.05
runs_decoated = ['Mn03082023']
...
if plot_corrected_rate:
    y_axis_act_lim = np.array([0.015, 11])
else:
...
indicator_box_y = [y_axis_act_lim[0], 0.04]
...
ax1.text(t1-arrow_offset_1-text_offset, np.sqrt(a224_0_zero*a224_1_zero), "$\mathrm{R_{upper}}$", 
...
ax1.text(t2+arrow_offset_2-text_offset, np.sqrt(a224_1_zero*a224_2_zero), "$\mathrm{R_{lower}}$", 
         ha='center', va='center', rotation=90, size=25+2, fontweight='semibold')
...
plt.savefig("implanted_ss_1_initial_ra224_1.pdf",dpi="figure")
plt.show()
