...
int analysis(){
	...
	std::pair<double, double> standard_act_err(51.64, 2.85);
	//std::pair<double, double> standard_act_err(25.19, 0.77); // A4 standard
	...
	// PTB Standard emanating since: 09.01.2020 11:17
        run_labels.push_back("First");
        filenames.push_back("Rn21022020");
	emanation_durations.push_back(1035./24.);
	...
	// PTB standard emanating since: 21.02.2020 15:22
        run_labels.push_back("Second");
        filenames.push_back("Rn11052020");
	...
	// PTB standard emanating since: 11.05.2020 12:21
	run_labels.push_back("Third");
	filenames.push_back("Rn04082020");
	emanation_durations.push_back(2046./24.);
	p_values.push_back(850);
	p_errors.push_back(std_p_err);
	channel_cuts_218.push_back(std::make_pair(170,200));
	channel_cuts_214.push_back(std::make_pair(200,250));

	// 4A standard emanating since: 26.05.2020 13:26
	run_labels.push_back("4A fourth");
	filenames.push_back("Rn18022019");
	emanation_durations.push_back(19.905486); // WRONG!
	p_values.push_back(850);
	p_errors.push_back(std_p_err);
	channel_cuts_218.push_back(std::make_pair(540,610));
	channel_cuts_214.push_back(std::make_pair(610,780));



/*
	// PTB standard emanating since: 04.08.2020 18:53
	// After exchange of diode... don't take this
	run_labels.push_back("fourth");
	filenames.push_back("Rn07092020");
	emanation_durations.push_back(811./24.);
	p_values.push_back(800);
	p_errors.push_back(std_p_err);
	channel_cuts_218.push_back(std::make_pair(170,200));
	channel_cuts_214.push_back(std::make_pair(200,250));
*/
