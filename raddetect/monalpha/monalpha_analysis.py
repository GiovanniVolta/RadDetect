...
class MonalphaAnalysis:
    ...
    def get_mca_histogram(self, MCA_range=[600, 715], time_range=[0, np.inf], n_channels=None):
        """
    ...
    def get_base_plot(self, MCA_range=[600, 715], time_range=[0, np.inf], n_channels=None, n_timestamp=None):
        """
    ...
    def get_mca_spectrum_fitting_object(self, model, init, limits=None, fixed=None, 
                                        MCA_range=[600, 715], time_range=[0, np.inf], MCA_counts_limit=5, n_channels=None, prefit=True):
        """
